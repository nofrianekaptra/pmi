...
@section('content')
    <div class="row">
        <div class="col-md-6">
            <div class="card border-danger">
                <div class="card-header">
                    Cetak Laporan Pendataan Darah Masuk
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card border-danger">
                <div class="card-header">
                    Cetak Laporan Pendataan Darah Keluar
                </div>
                <div class="card-body">
                    <form action="{{ route('laporan.dkt') }}" method="get" target="_blank"
                        onSubmit="window.location.reload()">
                        @csrf
                        <div class="mb-3">
                            <label for="" class="form-label">Cetak Laporan Tahunan</label>
                    ...
                    <hr>
                    <form action="{{ route('laporan.dkb') }}" method="get" target="_blank"
                        onSubmit="window.location.reload()">
                        <div class="mb-3">
                            <label for="" class="form-label">Cetak Laporan Tahunan</label>
                            <select name="bulan" class="form-control">
